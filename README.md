...
Копируем результат в созданный конфиг в папке ~/.kube
...
Используем токен для входа в Kubernetes

![alt text](https://github.com/MaratKN/kuber-homeworks-01/blob/main/4.png)
